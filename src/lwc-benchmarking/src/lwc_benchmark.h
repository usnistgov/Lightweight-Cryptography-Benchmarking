...
#if !defined(LWC_MODE_GENKAT_AEAD) && !defined(LWC_MODE_GENKAT_HASH) && \
    !defined(LWC_MODE_TIMING_AEAD) && !defined(LWC_MODE_TIMING_HASH) && \
    !defined(LWC_MODE_USE_AEAD_ENCRYPT) && !defined(LWC_MODE_USE_AEAD_DECRYPT) && !defined(LWC_MODE_USE_AEAD_BOTH) && !defined(LWC_MODE_USE_HASH)
...
#elif defined(LWC_MODE_USE_AEAD_ENCRYPT) || defined(LWC_MODE_USE_AEAD_DECRYPT) || defined(LWC_MODE_USE_AEAD_BOTH) || defined(LWC_MODE_USE_HASH)
