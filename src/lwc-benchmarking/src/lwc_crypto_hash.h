...
#ifndef LWC_CRYPTO_HASH_H
#define LWC_CRYPTO_HASH_H

#ifdef __cplusplus
extern "C" {
#endif

typedef int (*fn_hash)(unsigned char* out, const unsigned char* in, unsigned long long inlen);
