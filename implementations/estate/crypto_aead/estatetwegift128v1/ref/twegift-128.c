 ...
 * 
 * 
 * TweGift-128 is a minor extension of GIFT-128 block cipher (by Banik
 * et al. [1,2]) in that it accepts a short tweak of size 1 nibble. We
 * have used the reference source code for GIFT-128 (available at
 * [3]) by the GIFT team as the base for TweGift-128.
 * 
 ...
 * 
 */ 
#define CRYPTO_EXPTWEAKNIBBLES (8)
 ...
 */ 
#define CRYPTO_TWEAKING_PERIOD (5)
...
void expand_tweak(u8 *exp_twk, const u8 *twk)
{
	...
	// expand tweak nibble to a byte by copying the given nibble to
	// another nibble.
 ...
 * @name	:	twegift_enc
 * 
 * @note	:	TweGift-128 encryption function.
 * 
 **********************************************************************/
 ...
 * @name	:	twegift_dec
 * 
 * @note	:	TweGift-128 decryption function.
 * 
 **********************************************************************/	
